...
<iframe src="/pdf/07-llm-wiki_v1.0.pdf"
        width="100%"
        height="600px"
        style="border: 1px solid #ddd; border-radius: 4px;">
  PDF를 표시할 수 없습니다. <a href="/pdf/07-llm-wiki_v1.0.pdf">다운로드</a>하세요.
</iframe>

> 📥 [PDF 다운로드](/pdf/07-llm-wiki_v1.0.pdf) · [전체 화면 보기](/pdf/07-llm-wiki_v1.0.pdf)
